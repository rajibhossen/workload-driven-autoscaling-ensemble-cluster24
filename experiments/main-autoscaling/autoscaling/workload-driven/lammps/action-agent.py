...
def get_current_node_count():
    subprocess.run(['kubectl', 'cp', '-n', 'flux-operator', 'flux-sample-0-2dn29:/opt/lammps/examples/reaxff/HNS/node_counts.txt',
...
if __name__ == '__main__':
    prev_count = None
    yaml_filename = 'minicluster-lammps.yaml'
    ...
    while True:
        ...
        print("Waiting...")
        time.sleep(116)  # LAMMPS median runtime
