...
def get_current_node_count():
    subprocess.run(['kubectl', 'cp', '-n', 'flux-operator', 'flux-sample-0-2dn29:/opt/Kripke/node_counts.txt',
...
if __name__ == '__main__':
    prev_count = None
    yaml_filename = 'minicluster-kripke.yaml'
    ...
    while True:
        ...
        print("Waiting...")
        time.sleep(128)  # Kripke median runtime
