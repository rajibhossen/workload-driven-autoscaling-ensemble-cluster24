# Autoscaling static-64 cluster experiment with Flux and LAMMPS
Static cluster means we will deploy the cluster with predefined instance number(64 in this case) and we will not enable autoscaling. LAMMPS requires EFA enabled networking and a specific placement group.
