...
```console
eksctl create cluster -f flux-with-amg-setup/hpc7g-configs/eks-efa-cluster-config-hpc7g.yaml
...
kubectl apply -f flux-with-amg-setup/hpc7g-configs/minicluster-flux-view.yaml
```
